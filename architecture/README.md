...
The **full production** Spirl implementation (MCP, FastAPI, governance v3b knobs) lives in your separate **Spiral** application repo; this bundle intentionally ships the **evaluation + offline lab** slice so the GitHub repo stays cloneable without your entire product tree.
