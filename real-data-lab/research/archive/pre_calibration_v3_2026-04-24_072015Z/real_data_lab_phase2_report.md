...
Generated: 2026-04-23T14:44:35Z
...
- Total facts listed at audit: **110**
...
- Ambiguous routed to review (governance needs_review): **10** (1.0000)
- Unsafe forced-type rate: **0.0000** (governance-aware, contract `rdl-eval-2026-04-23-v2`)
- Governance outcome counts: `{"needs_review": 107, "typed_conflict": 2, "benign": 1}`
...
| `preflight_first_semantic_cross_type` | 13 |
| `preflight_abstain` | 2 |
| `none` | 1 |

## Winning plane / cross-type pressure

- Winning plane counts: `{"semantic": 52, "structural": 55, "governance_selector": 2}`
