...
Generated: 2026-04-13T17:57:34Z

Project: `dd6d8a9b-1c2f-4592-8e64-1253aaef953a`
...
| Exact-type detected | 55 |
| Exact-type recall | 0.5000 |
| Cross-type alerts | 41 |
| Abstained rows | 5 |
| Preflight-first detected rows | 80 |
...
| `dependency_impact` | 20 | 17 | 6 | 11 | 3 |
| `constraint_violation` | 20 | 19 | 19 | 0 | 1 |
| `temporal_invalidation` | 20 | 20 | 0 | 20 | 0 |
...
|--------------------------|-----:|
| `preflight_first_none_exact` | 53 |
| `preflight_first_none_cross_type` | 27 |
| `preflight_cross_type` | 23 |
| `none` | 5 |
| `preflight_exact` | 2 |

## Winning plane / cross-type pressure

- Winning plane counts: `{"none": 80}`
- Cross-type alerts by winning plane: `{"none": 41}`
...
|----------|---------:|-----------:|-----------:|---------:|-----:|
| `semantic_contradiction` | 30 | 4 | 5 | 1 | 0 |
| `dependency_impact` | 8 | 6 | 3 | 0 | 3 |
| `constraint_violation` | 0 | 0 | 19 | 0 | 1 |
| `temporal_invalidation` | 17 | 2 | 1 | 0 | 0 |
