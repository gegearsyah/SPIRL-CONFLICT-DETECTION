...
Generated (UTC): `2026-04-02T22:54:02Z`
...
- **Stacking:** Ablation: `no_stage15` (SparseCL bypassed), `sparsecl_rerank_only` (E-Verify forced off), `sparsecl_everify_on` (E-Verify forced on); same numeric grid each pass.
- **Gate overrides (research harness):** pool_sim_floor=`0.32` no fixed overrides for predicate / bidirectional / margin (Spiral defaults on each row)
...
|-------|----------:|----:|------:|---------:|:--:|---:|---:|---:|---:|------:|-----:|------:|-----:|-----:|-----:|----:|
| `no_stage15` | 0.580 | 0.940 | 0.200 | 0.820 | T | 11 | 29 | 0 | 26 | 100.00 | 27.50 | 100.00 | 0.00 | 72.50 | 56.06 | 43.14 |
| `sparsecl_everify_on` | 0.580 | 0.940 | 0.200 | 0.820 | T | 11 | 29 | 0 | 26 | 100.00 | 27.50 | 100.00 | 0.00 | 72.50 | 56.06 | 43.14 |
| `sparsecl_rerank_only` | 0.580 | 0.940 | 0.200 | 0.820 | F | 11 | 29 | 0 | 26 | 100.00 | 27.50 | 100.00 | 0.00 | 72.50 | 56.06 | 43.14 |

## Full mix (3 combinations)

| stack | embed_sim | nli | floor | high_sim | α | ev | TP | FN | FP | TN | Prec% | Rec% | Spec% | FPR% | FNR% | Acc% | F1% |
|-------|----------:|----:|------:|---------:|--:|:--:|---:|---:|---:|---:|------:|-----:|------:|-----:|-----:|-----:|----:|
| `no_stage15` | 0.580 | 0.940 | 0.200 | 0.820 | 1.00 | T | 11 | 29 | 0 | 26 | 100.00 | 27.50 | 100.00 | 0.00 | 72.50 | 56.06 | 43.14 |
| `sparsecl_everify_on` | 0.580 | 0.940 | 0.200 | 0.820 | 1.00 | T | 11 | 29 | 0 | 26 | 100.00 | 27.50 | 100.00 | 0.00 | 72.50 | 56.06 | 43.14 |
| `sparsecl_rerank_only` | 0.580 | 0.940 | 0.200 | 0.820 | 1.00 | F | 11 | 29 | 0 | 26 | 100.00 | 27.50 | 100.00 | 0.00 | 72.50 | 56.06 | 43.14 |
