...
Generated: 2026-04-13T09:01:52Z

Project: `45e87e14-c964-4ac6-8860-0f9a17efcaef`
...
| Binary detected (any alert) | 105 |
| Binary recall | 0.9545 |
| Exact-type detected | 65 |
| Exact-type recall | 0.5909 |
| Cross-type alerts | 31 |
| Abstained rows | 5 |
| Preflight-first detected rows | 105 |
| Preflight/async disagreements | 12 |
...
|----------------|-----------------:|-------------:|-----------------:|-----------:|----------:|
| `semantic_contradiction` | 40 | 40 | 34 | 6 | 0 |
| `dependency_impact` | 20 | 17 | 3 | 14 | 3 |
...
|--------------------------|-----:|
| `preflight_first_none_exact` | 65 |
| `preflight_first_none_cross_type` | 40 |
| `none` | 5 |

## Winning plane / cross-type pressure

- Winning plane counts: `{"none": 105}`
- Cross-type alerts by winning plane: `{"none": 31}`
...
|----------|---------:|-----------:|-----------:|---------:|-----:|
| `semantic_contradiction` | 34 | 0 | 5 | 1 | 0 |
| `dependency_impact` | 9 | 3 | 4 | 1 | 3 |
| `constraint_violation` | 0 | 0 | 19 | 0 | 1 |
| `temporal_invalidation` | 9 | 1 | 1 | 9 | 0 |
