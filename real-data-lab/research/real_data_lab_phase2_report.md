...
Generated: 2026-04-24T15:26:13Z
...
- Ambiguous routed to review (governance needs_review): **8** (0.8000)
- Unsafe forced-type rate: **0.2000** (governance-aware, contract `rdl-eval-2026-04-23-v2`)
- Governance outcome counts: `{"needs_review": 78, "typed_conflict": 30, "benign": 2}`
...
|----------------|-----------------:|-------------:|-----------------:|-----------:|----------:|
| `semantic_contradiction` | 40 | 40 | 29 | 11 | 0 |
...
| `preflight_first_semantic_exact` | 36 |
| `preflight_first_structural_cross_type` | 18 |
| `preflight_first_semantic_cross_type` | 16 |
| `none` | 2 |
| `preflight_abstain` | 1 |
...
- Cross-type alerts by winning plane: `{"structural": 15, "semantic": 9}`
